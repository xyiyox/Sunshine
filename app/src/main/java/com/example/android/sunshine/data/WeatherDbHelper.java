...
public class WeatherDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        // Create a table to hold locations. A location consist of a postal code
        // and a human-recognizable name
        ...
        final String SQL_CREATE_WEATHER_TABLE =
                ...
                // To assure the aplication has just one weather entry per day
